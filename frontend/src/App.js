...
class App extends Component {
  ...
  render() {
    ...
    return (
      <>
        <Navtab pr={this.props} loading={this.props.isLoading} auth={this.props.isAuthenticated} fail={this.props.isFailed} username={this.props.userAuthenticated} st={this.state} log={this.handleLogin} sign={this.handleSignup} out={this.handleLogout} />
      </>
    )
  }
}
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    onAuthSignup: (username, password1, password2) => dispatch(actions.authSignup(username, password1, password2)),
